...
export default function ProviderCard({ logo, games }: ProviderCardProps) {
  return (
    <div className="w-[88px] h-[60px] md:w-[152px] md:h-[100px] rounded-[8px] md:rounded-[12px] px-[14.4px] py-[7.2px] md:px-6 md:py-3 flex flex-col justify-center items-center gap-[4.8px] md:gap-2 bg-[#112F82] cursor-pointer transition-all duration-300 hover:bg-[#173EAD] hover:scale-[1.02]">
