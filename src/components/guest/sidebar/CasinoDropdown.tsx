    ...
    <div className="flex flex-col gap-[16px]">
      ...
      <div className="w-[200px] rounded-[8px] bg-[#112F82] overflow-hidden">
        <div className="h-[44px] bg-[#1463FF] px-[10px] flex items-center justify-between">
          <div className="flex items-center gap-[12px]">
            <Image
              src="/svg/sidebar/card-casino.svg"
              alt="casino"
              width={20}
              height={20}
            />
        ...
        <div className="px-[16px] py-[20px] flex flex-col gap-[20px]">
          ...
          <MenuItem
            text="All Games"
            icon="/svg/sidebar/game-console.svg"
          />

          {/* new games */}
          <MenuItem
            text="New Games"
            icon="/svg/sidebar/shiny-star.svg"
          />

          {/* popular games */}
          <MenuItem
            text="Popular Games"
            icon="/svg/sidebar/fire.svg"
          />

          {/* original games */}
          <MenuItem
            text="Original Games"
            icon="/svg/sidebar/thunder.svg"
          />

          {/* crash games */}
          <MenuItem
            text="Crash Games"
            icon="/svg/sidebar/rocket.svg"
          />
        </div>
      </div>
